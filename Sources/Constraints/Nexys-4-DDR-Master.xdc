...
set_property -dict { PACKAGE_PIN N14   IOSTANDARD LVCMOS33 } [get_ports { state_debug[0] }]; #IO_L8P_T1_D11_14 Sch=led[3]
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { state_debug[1] }]; #IO_L7P_T1_D09_14 Sch=led[4]
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { state_debug[2] }]; #IO_L18N_T2_A11_D27_14 Sch=led[5]
...
set_property -dict { PACKAGE_PIN G16   IOSTANDARD LVCMOS33 } [get_ports { mclk_cam }]; #IO_L13N_T2_MRCC_15 Sch=jb[3]
...
set_property -dict { PACKAGE_PIN H16   IOSTANDARD LVCMOS33 } [get_ports { pclk_cam }]; #IO_L13P_T2_MRCC_15 Sch=jb[10]
