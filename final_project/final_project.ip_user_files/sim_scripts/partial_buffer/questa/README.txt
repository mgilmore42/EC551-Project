...
#
# Generated by export_simulation on Wed Nov 02 22:58:02 -0400 2022
#
################################################################################
...
'-reset_run' switch to the './partial_buffer.sh' script.

./partial_buffer.sh -reset_run
...
./partial_buffer.sh -noclean_files

For more information on the script, please type './partial_buffer.sh -help'.
